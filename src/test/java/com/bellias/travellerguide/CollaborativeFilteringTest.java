...
class CollaborativeFilteringTest {
    ...
    void shouldGenerateRecommendationsForTraveller() {
        ...
        Traveller candidate = new Traveller(
                "John",
                new Date(),
                37.9838, 23.7275,
                travellerData,
        ...
        Traveller otherTraveller = new Traveller(
                "Alice",
                new Date(),
                41.9028, 12.4964, // Rome lat/lon
                otherTravellerData,
    ...
    void shouldReturnEmptyWhenTravellerHasNoHistory() {
        ...
        assertTrue(recommendations.isEmpty(), "Traveller with no history should yield no recommendations");
    }
}
