...
/**
 * The Construction of a class that represents a traveller. The class implements Comparable and
...
public class Traveller implements Comparable<Traveller>, Serializable {
  ...
  // =======================================================Traveller()========================================================
  /**
   * The most-used constructor defines the fields which describe the traveller with certain values
   * except field "visit".
   *
   * @param name the name of the traveller.
   * @param birthDate the birth date of the traveller.
  ...
  // =======================================================CompareCities()=====================================================
  /**
   * The method compares the cities given as argument and finds the city with the maximum
   * similarity.
   *
  ...
  public City CompareCities(ArrayList<City> Cities) {
    ...
    else if (!Cities.isEmpty()) withMostSimilarityCity = Cities.get(0); // Logical Error
  ...
  // =======================================================CompareCities()=====================================================
  /**
   * The method excludes the cities with the non-wanted weather and then applies overloading to
   * compare them.
   *
  ...
  // ===========================================================equals()========================================================
  /**
   * The method compares two traveller objects setting the uniqueness of Traveller objects via
   * traveller name.
   *
   * @param o the object which want to compare with the current object.
   * @return the result of comparing the object given with the current object only by traveller
   *     name.
   */
  // ===========================================================================================================================
  @Override
  ...
  public int hashCode() {
    ...
    hash =
        59 * hash
            + (int)
                (Double.doubleToLongBits(this.currentLat)
                    ^ (Double.doubleToLongBits(this.currentLat) >>> 32));
    hash =
        59 * hash
            + (int)
                (Double.doubleToLongBits(this.currentLon)
  ...
  public static Traveller findQualifiedCustomer(ArrayList<Traveller> travellers, City city) {
    ...
    else if (!travellers.isEmpty()) qualifiedCustomer = travellers.get(0);
  ...
  private static int findAge(Date birthDate) {
    ...
    // if month difference is in negative then reduce years by one and calculate the number of
    // months.
    if (months < 0) {
      years--;
