...
public class Tourist extends Traveller {
    ...
    // ========================================================Similarity()======================================================
    /**
     * The method calculates similarity between city's data and travellers' preferences but according
     * to the frequency to simulate the number of them in a city.
     *
