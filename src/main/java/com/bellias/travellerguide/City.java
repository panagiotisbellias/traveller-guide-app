...
public class City {
    ...
    // ============================================================City()============================================================
    /**
     * The constructor initializes the fields which describe the city name with certain values and the
     * rest fields with empty ones.
     *
     * @param cityName the name of the city.
     * @param cityCountry the first two-three letters of city's country.
     */
     ...
     * @return false in case we have to handle exceptions so there is a problem, and true in case of
    ...
    public boolean configureCity(String APPID) throws WikipediaNoArticleException, IOException {
      ...
      try {
        ...
        weatherT.start();
        while (weatherT.getOpenWeatherMapObject() == null) System.out.println("Data loading......");
    ...
    public int hashCode() {
      ...
      hash =
          13 * hash
              + (int)
                  (Double.doubleToLongBits(this.lat) ^ (Double.doubleToLongBits(this.lat) >>> 32));
      hash =
          13 * hash
              + (int)
                  (Double.doubleToLongBits(this.lon) ^ (Double.doubleToLongBits(this.lon) >>> 32));
      return hash;
    }
    ...
    /**
     * The method sets suggestedCityText JLabel according to the suggested city defined by
